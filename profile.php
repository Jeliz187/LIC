...
$sql6 = "SELECT Picture FROM Member_Picture WHERE MEmail = '".$w."';";
...
<body>
  <div class="container">
    <?php 	echo '<img src="data:image/jpeg;base64,' . base64_encode( $data ) . '" />'; ?>
  ...
  if($_SESSION["usertype"] == 2 || ($_SESSION['username'] == $_SESSION['pEmail'])){//type 2 is admin
    ...
    echo '<input type="hidden" class="form-control"  id="pEmail" name = "pEmail" placeholder = '.$eMail.'>';
    echo '<button type="submit" class="btn btn-primary" value="Submit3" name = "Submit3">Add Image</button>';
    echo '</form>';
  }
  ?>
